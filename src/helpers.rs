...
pub fn cbor_to_json_ext_old(value: &CborValue) -> JsonValue {
...
pub fn json_to_cbor_ext_old(json: &JsonValue) -> CborValue {
...
CONTENT = {
 ...
 //ARRAY example
 {
    value: {
        ...
        type: "array",
        data: [
             {tag: 42, type: "int", data: "111"},
             {tag: 42, type: "int", data: "222"},
             {tag: 42, type: "int", data: "333"},
        ]
    }
 }
